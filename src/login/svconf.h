...
typedef struct
{
    ...
    /* 16 */    char date_current_1[CONFIG_MAXBUF];   /* current date */
    /* 17 */    char date_current_2[CONFIG_MAXBUF];   /* current date */
    /* 18 */    char date_current_3[CONFIG_MAXBUF];   /* current date */
    /* 19 */    char date_time[CONFIG_MAXBUF];      /* current time */
} svconfig_t;
